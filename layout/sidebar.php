...
<div class="sidebar">
    ...
    <ul>
        ...
        ?>
            <li><a href="../pengguna/index.php">Manajemen Pengguna</a></li>
            <li><a href="../akun/index.php">Manajemen Akun</a></li>
            <li><a href="../customer/index.php">Manajemen Customer</a></li>
        <?php endif; ?>

        <?php if (has_permission('Admin') || has_permission('Pegawai') || has_permission('Pemilik')) : // Admin, Pegawai, Pemilik bisa lihat Pemesanan 
        ?>
            <li><a href="../pemesanan/index.php">Manajemen Pemesanan</a></li>
        <?php endif; ?>

        <?php if (has_permission('Admin') || has_permission('Pegawai')) : // Admin dan Pegawai bisa mengelola Transaksi & Kas Masuk 
        ?>
            <li><a href="../transaksi/index.php">Manajemen Transaksi</a></li>
            <li><a href="../kas_masuk/index.php">Manajemen Kas Masuk</a></li>
        <?php endif; ?>

        <?php if (has_permission('Admin')) : // Hanya Admin yang bisa mengelola Kas Keluar 
        ?>
            <li><a href="../kas_keluar/index.php">Manajemen Kas Keluar</a></li>
        <?php endif; ?>
